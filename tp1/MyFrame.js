...
export class MyFrame{
    ...
    display() {
        ...
        this.frameMesh.position.set(this.position.x, this.position.y, this.position.z)
        ...
        let pos = [this.position.x- this.width*0.2, this.position.y-this.height*0.3, this.position.z+this.depth/1.3]
        this.curve = new MyQuadraticBezier(this.app, points, pos, 16);
        this.curve.display();

        // Create the second wheel
        pos = [this.position.x+this.width*0.2, this.position.y-this.height*0.3, this.position.z+this.depth/1.3]
        this.curve = new MyQuadraticBezier(this.app, points, pos, 16);
        this.curve.display();
